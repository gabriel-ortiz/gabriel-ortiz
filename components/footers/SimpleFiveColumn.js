...
const Link = tw.a`border-b-2 border-transparent hocus:text-primary hocus:border-primary pb-1 transition duration-300`;

const LogoContainer = tw.div`flex items-center justify-center md:justify-start`;
const LogoImg = tw.img`w-8 mr-2`;
const LogoText = tw.h5`text-xl font-black text-primary`;
