...
export async function getAgilityPageProps({ context, res }) {
    ...
    console.log(
        `Agility CMS => Syncing ${isPreview ? 'Preview' : 'Live'} Mode`
    );
    ...
    //this is Actually  when we get the data
    if (pageInSitemap) {
        //get the page
